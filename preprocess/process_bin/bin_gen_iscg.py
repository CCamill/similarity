...
summary_root = r'/home/lab314/cjw/similarity/datasets/bin/clang/summary'    
...
def process_summary_file(summary_path, global_path, struct_path, iscg_path):
    ...
    for function_dict in summary_data:
        ...
        for index,block_info in enumerate(function['function_blocks']):
            ...
            for index,inst_info in enumerate(block_info['block_insts']):
                ...
                if inst_info.get['targets']:
                    operands = inst_info['operand_list'] + inst_info['targets']
                attr_dict = {'instruction':instruction, 'type': 'instruction','opcode':inst_info['opcode'],"operands": inst_info['operand_list'] }
                ...
                if inst_info['opcode'] == 'store':
                    if inst_info['operand_list'] == 1:
                        ...
                        G.add_node('called_fun_' + str(const_node_count),value = node_value)
                        operand_2 = inst_info['operand_list'][0]
                        G.add_edge('called_fun_' + str(const_node_count), inst_instID_dict[operand_2], edge_type='DataStore')
                        const_node_count += 1
                    else: 
                    ...
                    if operand_1.split()[-1] in function_params and operand_2 in function_instructions:
                        ...
                        G.add_node(const_id,type = 'const', value = operand_1.split()[-1])
                ...
                for operand in inst_info['operand_list']:
                    ...
                    if operand in global_list:
                        ...
                        if global_type not in ['string', 'struct']:
    ...
    #     return -1, inst_info['instruction'] + '======' + str(tb)
...
def process_proj(proj_root):
    ...
    iscg_proj_root = os.path.join(r'/home/lab314/cjw/similarity/datasets/bin/clang/iscg',proj_name)
...
if __name__ == '__main__':
    process_proj(r'/home/lab314/cjw/similarity/datasets/bin/clang/norm_summary/MayaPosch_____NymphCast')
